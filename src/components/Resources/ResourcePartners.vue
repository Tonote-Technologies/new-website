<template>
        ...
        <div class="col-12 text-center">
          <div class="section-title mb-4 pb-2 text-center">
            <div class="title2" style="display: inline-block">
              Affiliate and Partnership Referral Program
            </div>
          </div>
        </div>
        <!--end col-->
                    ...
                    <div class="section-title ms-lg-2 text-light p-2">
                      ...
                      <div style="">
                        <p class="small-text text-light">
                          ...
                          fellow professionals, entrepreneurs and businesses? Do
                          you want to make a passive income with minimal time
                          and effort? Then our affiliate marketing program is
                          for you.
                        </p>

                        <h2 class="py-2 text-light">How this works</h2>
                        ...
                        <table class="table mytable text-light">
                          <tr>
                            ...
                            <td>Register as an affiliate with ToNote</td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td>
                              Incorporate links into your website (blog and
                          ...
                          <tr>
                            ...
                            <td>Get paid for every successful referral!</td>
                          </tr>
                    ...
                    <div class="section-title ms-lg-2 text-light p-2">
                      ...
                      <div style="font-size: 14px">
                        <p>
                          ...
                          <br />
                          <br />
                          Invite your friends to try ToNote and get paid when
                          they use your code.
                        </p>
                        ...
                        <table class="table mytable text-light">
                          <tr>
                            ...
                            <td>
                              Earn commissions when you refer new customers to
                              ToNote.
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td>Simply click below to get started.</td>
                          </tr>
                          <tr>
                            <td colspan="2">
                              <div class="form-group mt-2 btn-route">
                      ...
                      <!-- <button class="btn btn-outline-light" style="color: #ccc">
                        Become a Partner
                      </button> -->
                    </div>
                  </div>
  ...
  <section class="section" id="partnerForm">
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-12 mx-auto py-1">
          <h1 class="text-center">Partner with us</h1>
          <p class="text-center">
            Join our Affiliate Program for free and earn a 20% commission from
            referrals to Africa’s foremost e-signature and virtual notarisation
            platform. Simply sign up, spread the word, and start earning.
          </p>
          <form class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 py-2 disclaimer">
              By clicking the button below, you agree to the
              <a href="#">Tonote’s General Terms</a> and acknowledge the
              <a href="#">Tonote’s Privacy Policy</a>. You also agree to be
              contacted at the email provided for marketing and public affairs
              purposes.
            </div>
